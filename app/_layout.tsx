...
function RootLayoutNav() {
    ...
    const navigate = async () => {
      ...
      if (isAuthenticated) {
        ...
        if (role === "relawan") {
          ...
          }else if(is_subcribed === 'Y' && pathname.startsWith("/(tabs)/relawan")){
            console.log("Redirecting to relawan tabs");
            router.replace("/(tabs)/relawan");
          }else if(is_subcribed === 'Y' && pathname.startsWith("/(tabs)/relawan/history")){
  ...
  return (
    <Stack screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="relawan/kegiatan/detail" options={{ headerShown: false }} />
      <Stack.Screen name="relawan/kegiatan/daftar" options={{ headerShown: false }} />
      <Stack.Screen name="relawan/history" options={{ headerShown: false }} />
      <Stack.Screen name="relawan/kegiatan/detailApply" options={{ headerShown: false }} />
