...
export default function NotifikasiRelawanScreen() {
      ...
      <ScrollView
        ...
        {notifikasiList.map((notifikasi) => (
          <View
            ...
            style={tw`bg-white border border-gray-200 rounded-2xl px-4 py-4 mb-4 border border-gray-100`}>
            <View style={tw`flex-row items-center justify-between`}>
              <View style={tw`flex-col w-full`}>
                ...
                <Text style={tw`text-blue-500 text-xs italic mt-2`}>
