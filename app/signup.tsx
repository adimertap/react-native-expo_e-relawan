...
import { Alert, Keyboard, KeyboardAvoidingView, Platform, Pressable, ScrollView, Text, TextInput, TouchableOpacity, TouchableWithoutFeedback, View } from "react-native";
            ...
            <View style={tw`mt-8`}>
              ...
              <View style={tw`pl-1 pr-1 mt-3`}>
                ...
                <View style={tw`mb-3 flex-row`}>
                  <TextInput
                    style={tw`border border-gray-200 rounded-full px-4 py-4 bg-white text-black flex-1 mr-2`}
                    placeholder="Phone"
              ...
              <View style={tw`mb-3`}>
                <Pressable
                  style={tw`border border-gray-200 rounded-full px-4 py-4 bg-white`}
                  onPress={() => setShowTanggalLahirPicker(true)}>
                  <Text style={tw`text-gray-500`}>
                    {tanggalLahir
                      ? new Date(tanggalLahir).toLocaleDateString()
                      : "Tanggal Lahir"}
                  </Text>
                </Pressable>
                {tanggalLahirError ? (
